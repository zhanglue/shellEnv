...
"-----------------------------------------------------------------------
"增加了c语言的std的语法高亮
so  ${HOME}/.vim/syntax/c_std_func_highlight.vim 
"-----------------------------------------------------------------------
"-----------------------------------------------------------------------
"========================================================
" My Own DataType
...
syn keyword cType        oaUInt4 oaString oaArray oaInst  oaDesign oaBlock  
syn keyword cType        QString QStringList QLatin1String QLatin1Char QChar QTextEdit QTextCursor QList QTextCursor
"-----------------------------------------------------------------------
