...
if !exists("python_no_builtin_highlight")
  ...
  syn keyword pythonBuiltin	compile complex delattr dict dir
  ...
  syn keyword pythonBuiltin	setattr slice sorted str
  syn keyword pythonBuiltin	sum tuple type vars zip __import__
  " Python 2 only
  syn keyword pythonBuiltin	basestring cmp execfile file
  syn keyword pythonBuiltin	long reduce reload unichr
  ...
  syn keyword pythonBuiltinII   property range repr reversed round set super 
  syn keyword pythonBuiltinII   self staticmethod classmethod print input raw_input
  syn keyword pythonBuiltinIII	False True None
...
" Highlight +-*/=
syn keyword pythonLogicOperator	  and in is not or
...
hi def link pythonStructure		Statement
if !exists("python_no_number_highlight")
  hi def link pythonNumber		Todo
endif
if !exists("python_no_builtin_highlight")
  hi def link pythonBuiltin		Function
  hi def link pythonBuiltinII		Structure
  hi def link pythonBuiltinIII		Special
endif
if !exists("python_no_exception_highlight")
...
hi def link pythonLogicOperator		Operator
hi def link pythonMathOperator		Special
